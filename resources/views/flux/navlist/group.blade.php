...
{{--    >--}}
    <button
        type="button"
        class="group/disclosure-button mb-[2px] flex h-10 w-full items-center rounded-lg text-zinc-500 lg:h-8 dark:text-white/80"
        disabled
    >
{{--        <div class="ps-3 pe-4">--}}
...
{{--        </div>--}}
        ...
        <span class="ml-3 mt-2 text-base font-bold leading-none">{{ $heading }}</span>
    </button>
