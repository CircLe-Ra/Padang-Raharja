...
$classes = Flux::classes()
    ...
    ->add($square ? '' : 'px-2.5!')
    ->add('text-zinc-50 dark:text-white/80 ')
    ...
    ->add(match ($accent) {
        true => [
            ...
            'data-current:text-white hover:data-current:text-white hover:bg-white/5 dark:hover:bg-white/10 hover:data-current:bg-white/10',
            'data-current:after:bg-orange-900 dark:data-current:after:bg-white',
        ],
        false => [
            'hover:text-white dark:hover:text-white',
            'data-current:text-white dark:data-current:text-zinc-50 hover:bg-zinc-50 dark:hover:bg-white/10',
