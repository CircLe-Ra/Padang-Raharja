...
new
#[\Livewire\Attributes\Title('Master Data - Sejarah Kampung')]
class extends Component {

    public string $content = '';

    public function mount() {
        $this->content = VillageProfile::where('id', 1)->first()->history ?? '';
    }

    #[\Livewire\Attributes\On('trix_value_updated')]
    public function historyUpdate($value): void
    {
        $this->content = $value;
    }
...
<x-master-data.sidebar active="Sejarah Kampung">
    <x-slot name="action">
    ...
    <div class="p-6 border border-zinc-200 dark:border-zinc-700 mt-2 rounded-lg bg-zinc-50 dark:bg-zinc-900">
        <flux:heading size="xl" level="1">Sejarah</flux:heading>
        <flux:subheading class="mb-2">Sejarah Kampung Padang Raharja</flux:subheading>
        <div class="mt-4">
